# Search Term Popularity Calculator | [![Build Status](https://travis-ci.com/HcsOmot/search-term-popularity.svg?branch=master)](https://travis-ci.com/HcsOmot/search-term-popularity)
